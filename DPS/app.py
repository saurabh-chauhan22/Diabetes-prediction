...
def up_pass():
    ...
    if request.method == 'POST' and 'pass' in request.form:
        ...
        if 'loggedin' in session:
            ...
            password = request.form['pass']
            # email = request.form['email']
            connection = sql_db.connect(host='127.0.0.1',
                                        database='diabetes',
                                        user='root',
                                        password='')
...
def train():
    ...
    pickle.dump(classifier, open('E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS/model.pkl', 'wb'))
    flash("Model Trained!!")

    # Loading model to compare the results
    model = pickle.load(open('E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS/DPS/model.pkl', 'rb'))
...
def perform():
    ...
    # plt.savefig('/Users/vidhijhabak/Desktop/Diabetes-Prediction-System-master/DPS/static/images/perf.png')

    return render_template('dashboard.html', name='Plot Showing Accuracy of Different Algorithms:',
                           url='/static/images/perf.png')


@app.route('/report/')
def report():
    # path = "/Users/vidhijhabak/Desktop/Diabetes-Prediction-System-master/DPS/Report.pdf"
...
def save_data(result):
    ...
    if request.method == 'POST':
        ...
        ordered_fieldnames = OrderedDict(
            [('pregnant', None), ('glucose_tolerance_test', None), ('Diastolic_blood_pressure', None),
             ('Triceps_skin_fold_thickness', None), ('serum_insulin', None), ('Body_mass_index', None),
             ('Diabetes_pedigree_function', None), ('Age', None), ('class', None)])
        with open('data.csv', 'a') as inFile:
            ...
            dw.writerow({'pregnant': pregnant_times, 'glucose_tolerance_test': glucose_tolerance_test,
                         'Diastolic_blood_pressure': Diastolic_blood_pressure,
                         'Triceps_skin_fold_thickness': Triceps_skin_fold_thickness, 'serum_insulin': serum_insulin,
                         'Body_mass_index': Body_mass_index, 'Diabetes_pedigree_function': Diabetes_pedigree_function,
                         'Age': Age, 'class': result})
            ...
            pdf.image(
                "E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS\static\images" + '/' + "img1" + '.jpg',
                w=50, h=50)
            # date = dt.date()
            ...
            pdf.cell(190, 10, ('Triceps_skin_fold_thickness: %s' % Triceps_skin_fold_thickness), ln=1, align="L",
                     border=1)
            ...
            pdf.cell(190, 10, ('Diabetes_pedigree_function: %s' % Diabetes_pedigree_function), ln=1, align="L",
                     border=1)
            ...
            if result == 1:
                ...
                pdf.image(
                    "E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS\static\images" + '/' + "sol" + '.jpg',
                    w=180, h=200)
            else:
                ...
                pdf.multi_cell(190, 10, ('Suggestions: %s' % sugg), align="L", border=1)
                pdf.image(
                    "E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS\static\images" + '/' + "prev" + '.jpeg',
                    w=180, h=220)
            # pdf.cell(200, 10, txt=pregnant_times, ln=1, align="C")
...
model = pickle.load(open('E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS/model.pkl', 'rb'))


def ValuePredictor(to_predict_list):
    to_predict = np.array(to_predict_list).reshape(1, 8)
    loaded_model = pickle.load(open("E:\Study\Diabetes Prediction\Diabetes-Prediction-System-master\Diabetes-Prediction-System-master\DPS/model.pkl", "rb"))
